...
import static me.anemoi.rendertools.utils.render.RenderUtils.Helper.*;
import static me.anemoi.rendertools.utils.render.RenderUtils.World.*;
import static me.anemoi.rendertools.utils.render.RenderUtils.Screen.*;
import static me.anemoi.rendertools.utils.render.RenderUtils.Entity.*;
import static me.anemoi.rendertools.utils.render.RenderUtils.Shader.*;
...
public class RenderUtils {
    ...
    public static class World {
        ...
        public static void drawPlatform(final net.minecraft.entity.Entity entity, final Color color, float partialTicks) {
            final RenderManager renderManager = mc.getRenderManager();
         ...
         */
    /*
    public static void renderBeaconBeam(double x, double y, double z, Color aColor, float partialTicks) {
...
//because of the way 3D rendering is done, all coordinates are relative to the camera.  This "resets" the "0,0,0" position to the location that is (0,0,0) in the world.
    ...
    */
        ...
        public static void renderWaypointText(String str, double X, double Y, double Z, float partialTicks) {
            ...
            net.minecraft.entity.Entity viewer = RenderTools.mc.getRenderViewEntity();
            ...
            GlStateManager.rotate(-RenderTools.mc.getRenderManager().playerViewY, 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(RenderTools.mc.getRenderManager().playerViewX, 1.0F, 0.0F, 0.0F);
     ...
     */
        public static void drawLine(Vec3 pos1, Vec3 pos2, Color colour, float partialTicks, boolean depth) {
            net.minecraft.entity.Entity render = Minecraft.getMinecraft().getRenderViewEntity();
        ...
        public static void drawLinesVec3(java.util.List<Vec3> poses, Color colour, float thickness, float partialTicks, boolean depth) {
            net.minecraft.entity.Entity render = Minecraft.getMinecraft().getRenderViewEntity();
            WorldRenderer worldRenderer = Tessellator.getInstance().getWorldRenderer();
            ...
            for (Vec3 pos : poses) {
                worldRenderer.pos(pos.xCoord + 0.5, pos.yCoord + 0.5, pos.zCoord + 0.5).endVertex();
            }
            Tessellator.getInstance().draw();
    ...
    public static class Entity {
        public static void drawEntityBox(final net.minecraft.entity.Entity entity, final Color color, final int width, float partialTicks) {
            if (width == 0) return;
            final RenderManager renderManager = mc.getRenderManager();
        ...
        //draw a entity box but instead of using the entity's bounding box, use a location and size
        public static void drawEntityBox(final Vec3 vec, final Color color, final int width, float partialTicks, double size) {
            if (width == 0) return;
            final RenderManager renderManager = mc.getRenderManager();
        ...
        public static void drawNametag(String str) {
            FontRenderer fontrenderer = RenderTools.mc.fontRendererObj;
            float f = 1.6F;
    ...
    public static class Screen {
        ...
        public static void drawLine(long vg, float width, float startX, float startY, int color, HashMap<Float, Float> points) {
            nvgBeginPath(vg);
        ...
        public static void drawLine(long vg, float width, float startX, float startY, float endX, float endY, int color) {
            nvgBeginPath(vg);
...
*/
        ...
        public static void drawGlowingRoundedRect(long vg, float x, float y, float width, float height, int color, float radius, int glowColor, float glowStrength, float glowHardness) {
        ...
        //draw glowing rounded rectagle using gradient
        public static void drawGlowingRoundedRect2(long vg, float x, float y, float width, float height, int color, float radius, int glowColor, float glowStrength, float glowRadius) {
            Color glow = new Color(glowColor);
            //draw glow
    ...
    public static class Helper {
        ...
        public static void resetCaps() {
            glCapMap.forEach(RenderUtilsNew::setGlState);
        }
     ...
     */
        ...
        public static boolean isInViewFrustrum(net.minecraft.entity.Entity entity) {
